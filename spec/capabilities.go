...
type CapsHostNUMAPageInfo struct {
	Size  int32  `xml:"size,attr" json:"size"`
	Unit  string `xml:"unit,attr" json:"unit"`
	Count uint64 `xml:",chardata" json:"count"`
}

type CapsHostNUMACPU struct {
	ID       int32  `xml:"id,attr" json:"id"`
	SocketID *int   `xml:"socket_id,attr" json:"socketId"`
	DieID    *int   `xml:"die_id,attr" json:"dieId"`
	CoreID   *int   `xml:"core_id,attr" json:"coreId"`
...
type CapsHostNUMACPUs struct {
	Num  uint32            `xml:"num,attr,omitempty" json:"num,omitempty"`
...
type CapsHostCacheBank struct {
	...
	Level   uint32                 `xml:"level,attr" json:"level"`
	Type    string                 `xml:"type,attr" json:"type"`
	Size    uint32                 `xml:"size,attr" json:"size"`
	Unit    string                 `xml:"unit,attr" json:"unit"`
...
type CapsHostCacheMonitor struct {
	Level          uint32                        `xml:"level,attr,omitempty" json:"level,omitempty"`
	ResueThreshold uint32                        `xml:"reuseThreshold,attr,omitempty" json:"resueThreshold,omitempty"`
	MaxMonitors    uint32                        `xml:"maxMonitors,attr" json:"maxMonitors"`
...
type CapsHostCacheControl struct {
	Granularity uint32 `xml:"granularity,attr" json:"granularity"`
	Min         uint32 `xml:"min,attr,omitempty" json:"min,omitempty"`
	Unit        string `xml:"unit,attr" json:"unit"`
	Type        string `xml:"type,attr" json:"type"`
	MaxAllows   uint32 `xml:"maxAllocs,attr" json:"maxAllows"`
}
...
type CapsHostMemoryBandwidthNodeControl struct {
	Granularity uint32 `xml:"granularity,attr" json:"granularity"`
	Min         uint32 `xml:"min,attr" json:"min"`
	MaxAllocs   uint32 `xml:"maxAllocs,attr" json:"maxAllocs"`
}

type CapsHostMemoryBandwidthMonitor struct {
	MaxMonitors uint32                                  `xml:"maxMonitors,attr" json:"max_monitors"`
