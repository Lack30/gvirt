...
type NetworkDHCPLease struct {
	Expiry int32  `xml:"expiry,attr" json:"expiry"`
...
type NetworkDNSSRV struct {
	...
	Weight   int32    `xml:"weight,attr,omitempty" json:"weight,omitempty"`
	Domain   string   `xml:"domain,attr,omitempty" json:"domain,omitempty"`
}
...
type NetworkBandwidthParams struct {
	Average *int32 `xml:"average,attr" json:"average"`
	Peak    *int32 `xml:"peak,attr" json:"peak"`
	Burst   *int32 `xml:"burst,attr" json:"burst"`
	Floor   *int32 `xml:"floor,attr" json:"floor"`
}

type NetworkBandwidth struct {
	ClassID  int32                   `xml:"classID,attr,omitempty" json:"classId"`
