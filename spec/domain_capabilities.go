...
type DomainCapsVCPU struct {
	Max int32 `xml:"max,attr" json:"max"`
}
...
type DomainCapsFeatureSEV struct {
	Supported       string `xml:"supported,attr" json:"supported"`
	CBitPos         int32  `xml:"cbitpos,omitempty" json:"cBitPos,omitempty"`
	ReducedPhysBits int32  `xml:"reducedPhysBits,omitempty" json:"reducedPhysBits,omitempty"`
}
