...
type InterfaceLink struct {
	Speed int32  `xml:"speed,attr,omitempty" json:"speed,omitempty"`
...
type InterfaceBondARPMon struct {
	Interval int32  `xml:"interval,attr,omitempty" json:"interval,omitempty"`
...
type InterfaceBondMIIMon struct {
	Freq    int32  `xml:"freq,attr,omitempty" json:"freq,omitempty"`
	UpDelay int32  `xml:"updelay,attr,omitempty" json:"updelay,omitempty"`
...
type InterfaceVLAN struct {
	Tag       *int32     `xml:"tag,attr" json:"tag,omitempty"`
