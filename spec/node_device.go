...
type NodeDevicePCIExpressLink struct {
	...
	Port     *int32  `xml:"port,attr" json:"port"`
...
type NodeDevicePCICapability struct {
	...
	Domain       *int32                       `xml:"domain" json:"domain,omitempty"`
	Bus          *int32                       `xml:"bus" json:"bus,omitempty"`
	Slot         *int32                       `xml:"slot" json:"slot,omitempty"`
	Function     *int32                       `xml:"function" json:"function,omitempty"`
...
type NodeDeviceMDevType struct {
	...
	AvailableInstances int32  `xml:"availableInstances" json:"availableInstances"`
}
...
type NodeDeviceSCSIHostCapability struct {
	Host       int32                             `xml:"host" json:"host"`
	UniqueID   *int32                            `xml:"unique_id" json:"uniqueId,omitempty"`
...
type NodeDeviceStorageRemovableCapability struct {
	MediaAvailable   *int32 `xml:"media_available" json:"mediaAvailable,omitempty"`
	MediaSize        *int32 `xml:"media_size" json:"mediaSize,omitempty"`
	MediaLabel       string `xml:"media_label,omitempty" json:"mediaLabel,omitempty"`
	LogicalBlockSize *int32 `xml:"logical_block_size" json:"logicalBlockSize,omitempty"`
	NumBlocks        *int32 `xml:"num_blocks" json:"numBlocks,omitempty"`
}
...
type NodeDeviceStorageCapability struct {
	...
	Size             *int32                           `xml:"size" json:"size,omitempty"`
	LogicalBlockSize *int32                           `xml:"logical_block_size" json:"logicalBlockSize,omitempty"`
	NumBlocks        *int32                           `xml:"num_blocks" json:"numBlocks,omitempty"`
...
type NodeDeviceCCWCapability struct {
	CSSID *int32 `xml:"cssid" json:"cssid,omitempty"`
	SSID  *int32 `xml:"ssid" json:"ssid,omitempty"`
	DevNo *int32 `xml:"devno" json:"devno,omitempty"`
}
